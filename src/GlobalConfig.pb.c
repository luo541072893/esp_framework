...
/* Generated by nanopb-0.3.9.4 at Sun Sep 26 11:47:57 2021. */
...
const pb_field_t WifiConfigMessage_fields[9] = {
    ...
    PB_FIELD(  8, BOOL    , SINGULAR, STATIC  , OTHER, WifiConfigMessage, is_restart, ntp, 0),
    PB_LAST_FIELD
};
...
const pb_field_t DebugConfigMessage_fields[7] = {
    ...
    PB_FIELD(  4, UINT32  , SINGULAR, STATIC  , OTHER, DebugConfigMessage, seriallog_level, port, 0),
    PB_FIELD(  5, UINT32  , SINGULAR, STATIC  , OTHER, DebugConfigMessage, weblog_level, seriallog_level, 0),
    PB_FIELD(  6, UINT32  , SINGULAR, STATIC  , OTHER, DebugConfigMessage, syslog_level, weblog_level, 0),
    PB_LAST_FIELD
};
